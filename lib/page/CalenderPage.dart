        ...
        children: [
          ...
          Expanded(
            child: ListView.builder(
              itemCount: (_events[_selectedDate.toIso8601String().split('T')[0]] ?? []).length,
              itemBuilder: (context, index) {
                String dateKey = _selectedDate.toIso8601String().split('T')[0];
                var event = _events[dateKey]?[index];
                return ListTile(
                ...
                content: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      if (pickedTime != null) Text('Selected Time: ${pickedTime!.format(context)}'),
                      SizedBox(height: 10),
                      Row(
                        children: [
                          Expanded(
